...
(defdialect cmulisp-normal "CMU Common Lisp -- normal core" %%cmulisp
  ...
  (ilisp-load-init 'cmu "/usr/lib/common-lisp/cmucl-normal/ilisp/cmulisp"))

(defdialect cmulisp "CMU Common Lisp" %%cmulisp
  (ilisp-load-init 'ilisp-package-kludge "/usr/share/ilisp/ilisp-pkg")
  (ilisp-load-init 'common-lisp "/usr/share/ilisp/cl-ilisp")
  (ilisp-load-init 'cmu "/usr/share/ilisp/cmulisp"))

(defdialect cmulisp-safe "CMU Common Lisp -- safe core" %%cmulisp
  ...
  (ilisp-load-init 'cmu "/usr/lib/common-lisp/cmucl-safe/ilisp/cmulisp"))

(defdialect cmulisp-small "CMU Common Lisp -- small core" %%cmulisp
  ...
  (ilisp-load-init 'cmu "/usr/lib/common-lisp/cmucl-small/ilisp/cmulisp"))
